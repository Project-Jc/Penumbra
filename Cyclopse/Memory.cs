...
namespace MemoryEditor
{
	...
	public class Memory
	{
        private static Process mReadProcess = null;
        ...
        public IntPtr ReturnhReadProcess()
        {
            return hReadProcess;
        }
        public int ReturnmReadProcess()
        {
		...
		public int BaseAddress()
		{
            ...
            {
                System.Windows.Forms.MessageBox.Show("Win32Exception Error in Memory.cs~BaseAddress()");
            }
            return 0;
		}
